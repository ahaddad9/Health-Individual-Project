...
with tab_dash:
    ...
    st.markdown(
        ...
        <b>What this means:</b> what adds years of life is targeted investment in
        these three pillars, prevention, environment, and reach, not the size of
        the health budget. A country can score well on all three at modest spending,
        and spending heavily without moving them buys very little.</div>""",
    ...
    st.caption("Life expectancy shows the raw level. The efficiency gap is each "
               "country's actual life expectancy minus what the global spending curve "
               "predicts for its level of health spending. Blue means a country gets "
               "more years than its spending predicts, so it converts money into health "
               "efficiently; red means fewer years than predicted, so it overspends for "
               "the result. The US is among the reddest of the high-spending countries.")
